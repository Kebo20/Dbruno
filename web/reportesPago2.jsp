				...
				<section role="main" class="content-body">
					...
					<!-- start: page -->
							...
							<header class="panel-heading">
								 <h2 class="panel-title" style='color: #007ebd'>Reporte de <%=request.getParameter("dia") %> de <%=mes  %> - PAGOS </h2>
							</header>
							<div class="panel-body">
                                                            ...
                                                            <div id="areaImprimir" >
                                                                <h2 class="panel-title" style='color: #ffffff'>Reporte de <%=request.getParameter("dia") %> de <%=mes  %> - PAGOS</h2>
                                                                <br>
									...
									<tbody>
                                                                            <%double total=0.0; %>
                                                                            <% for(Pago p:PagoDao.listar(request.getParameter("mes"),request.getParameter("dia"))) {%>
										<tr class="gradeX">
                                                                                      <% DecimalFormat f = new DecimalFormat("0.00");%>
                                                                                     
                                                                                             
                                                                                        
                                                                                      <td class="center hidden-phone" style="padding-top: 0px;padding-bottom:   0px;width:50%;color: #000"><%=ClienteDao.cliente(p.getId_cliente())%></td>
                                                                                      
                                                                                      
                                                                                    <td class="center hidden-phone" style="padding-top: 0px;padding-bottom:   0px;width:50%;color: #000">S/. <%=f.format(p.getPago_diario()) %></td>
                                                                                        
                                                                                   <%total=total+p.getPago_diario();%> 
                                                                                </tr>
								               <%} %>		
									</tbody>
