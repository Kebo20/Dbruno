				...
				<section role="main" class="content-body">
					...
					<!-- start: page -->
							...
							<header class="panel-heading">
								 <h2 class="panel-title" style='color: #007ebd'>Reporte de <%=mes  %> - COMPRAS</h2>
							</header>
							<div class="panel-body">
                                                            ...
                                                            <div id="areaImprimir" >
                                                                <h2 class="panel-title" style='color: #ffffff'>Reporte de <%=mes  %> - COMPRAS</h2>
                                                                <br>
									...
									<tbody>
                                                                           <% double total=0.0; %>
                                                                            <% for(Compra co:CompraDao.listar(request.getParameter("mes"))) {%>
										<tr class="gradeX">
