					...
					<!-- start: page -->
							...
							<section class="panel">
                                                            <header class="panel-heading">
                                                                <h2 class="panel-title" style='color: #007ebd'>Reporte de  <%=request.getParameter("dia")%> de <%= mes  %> - COMPRAS</h2>
                                                            </header>
							<div class="panel-body">
                                                            ...
                                                            <div id="areaImprimir" >
                                                                <h2 class="panel-title" style='color: #ffffff'>Reporte de  <%=request.getParameter("dia")%> de <%= mes  %> - COMPRAS</h2>
                                                                <br>
                                                            ...
                                                            %>
                                                            <% for(int i=0 ; i<3 ; i++) {%> 
                                                            <%if (CompraDao.Compras_dia_tipo(request.getParameter("mes"),request.getParameter("dia"),tipos.get(i))) { %>
									...
									<tbody>
                                                                            ...
                                                                            %>
                                                                            <% for(Compra co:CompraDao.listar(request.getParameter("mes"),request.getParameter("dia"),tipos.get(i))) {%>
										<tr class="gradeX">
                                                                                      <% DecimalFormat f = new DecimalFormat("0.00");%>
                                                                                     
                                                                                       <td class="center hidden-phone" style="padding-top: 0px;padding-bottom:   0px;width:30%;color: #000"><%=co.getNum_guia() %></td>
                                                                                       <td class="center hidden-phone" style="padding-top: 0px;padding-bottom:   0px;width:15%;color: #000"><%=co.getDescripcion() %></td>
                                                                                        
                                                                                        											
                                                                                        <td class="center hidden-phone" style="padding-top: 0px;padding-bottom:   0px;width:10%;color: #000"><%=co.getNum_pollos() %></td>
                                                                                       
                                                                                        
                                                                                        <td class="center hidden-phone" style="padding-top: 0px;padding-bottom:   0px;width:15%;color: #000"><%=co.getCan_kilo() %> Kg.</td>
											
                                                                                        <td class="center hidden-phone" style="padding-top: 0px;padding-bottom:   0px;width:15%;color: #000">S/. <%=f.format(co.getPrecio_kilo())%></td>
											
                                                                                        <td class="center hidden-phone" style="padding-top: 0px;padding-bottom:   0px;width:15%;color: #000">S/. <%=f.format(co.getTotal_compra())%></td>
                                                                                        <%
                                                                                            cantidad=cantidad+co.getCan_kilo();
                                                                                            pollos=pollos+co.getNum_pollos();
                                                                                            total=total+co.getTotal_compra();
                                                                                        %>
