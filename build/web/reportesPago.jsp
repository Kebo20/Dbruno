				...
				<section role="main" class="content-body">
					...
					<!-- start: page -->
							...
							<header class="panel-heading">
								 <h2 class="panel-title" style='color: #007ebd'>Reporte de <%=mes  %> - PAGOS</h2>
							</header>
							<div class="panel-body">
                                                            ...
                                                            <div id="areaImprimir" >
                                                                <h2 class="panel-title" style='color: #ffffff'>Reporte de <%=mes  %> - PAGOS</h2>
                                                                <br>
									...
									<tbody>
                                                                            <%double total=0.0; %>
                                                                            <% for(Pago p:PagoDao.listar(request.getParameter("mes"))) {%>
										<tr class="gradeX">
                                                                                      
                                                                                     <% DecimalFormat f = new DecimalFormat("0.00");%>
                                                                                    <td class="center hidden-phone" style="padding-top: 0px;padding-bottom:   0px;width:50%;color: #000"><%=p.getFecha_pago()%></td>
