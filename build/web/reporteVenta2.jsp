				...
				<section role="main" class="content-body">
					...
					<!-- start: page -->
							...
							<header class="panel-heading">
                                                            <h2 class="panel-title" style='color: #007ebd'>Reporte de <%=request.getParameter("tipo") %> de <%=mes  %> - VENTAS</h2>
							</header>
							<div class="panel-body">
                                                            ...
                                                            <div id="areaImprimir" >
                                                                <h2 class="panel-title" style='color: #ffffff'>Reporte de <%=request.getParameter("tipo") %> de <%=mes  %> - VENTAS</h2>
                                                                <br>
									...
									<tbody>
                                                                            <%double total=0.0; %>
                                                                            <% for(Venta v:VentaDao.listar(request.getParameter("mes"),request.getParameter("tipo"))) {%>
										<tr class="gradeX">
									   ...
									   <thead>
										<tr>
											<th class="hidden-phone" style="text-align: center;border :#ffffff "></th>
											
											<th class="hidden-phone" style="text-align: center;border :#ffffff "></th>
                                                                                        <% DecimalFormat f = new DecimalFormat("0.00");%>
                                                                 
											<th class="hidden-phone" style="text-align: center;border :#ffffff;color:#000 "><b>S/.<%=f.format(total)%></b></th>
									...
									<tbody>
										...
										<tr class="gradeX">
											...
											<td class="center hidden-phone" style="width: 25%;color: #000;border :#ffffff "></td>
                                                                                        ...
                                                                                        <td class="center hidden-phone" style="width: 25%;color: #000 ;border :#ffffff"></td>
                                                                                        <td class="center hidden-phone" style="width: 50%;color: #000;border :#ffffff" ></td>
