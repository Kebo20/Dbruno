				...
				<section role="main" class="content-body">
					...
					<!-- start: page -->
							...
							<header class="panel-heading">
                                                            <h2 class="panel-title" style='color: #007ebd'>Reporte de <%=request.getParameter("tipo") %> de <%=mes  %>  - COMPRAS</h2>
							</header>
							<div class="panel-body">
                                                            ...
                                                            <div id="areaImprimir" >
                                                                <h2 class="panel-title" style='color: #ffffff'>Reporte de <%=request.getParameter("tipo") %> de <%=mes  %> - COMPRAS</h2>
                                                                <br>
									...
									<tbody>
                                                                             <%double total=0.0; %>
                                                                            <% for(Compra co:CompraDao.listar(request.getParameter("mes"),request.getParameter("tipo") )) {%>
										<tr class="gradeX">
                                                                                      
                                                                                     <% DecimalFormat f = new DecimalFormat("0.00");%>
                                                                                    <td class="center hidden-phone" style="padding-top: 0px;padding-bottom:   0px;width:50%;color: #000"><span style='display: none;'><%=co.getFecha_compra().substring(6,10)+co.getFecha_compra().substring(3,5)+co.getFecha_compra().substring(0,2) %></span><%=co.getFecha_compra() %></td>
                                                                                   
                                                                                    <td class="center hidden-phone" style="padding-top: 0px;padding-bottom:   0px;width:50%;color: #000">S/. <%=f.format(co.getTotal_compra())%></td>
